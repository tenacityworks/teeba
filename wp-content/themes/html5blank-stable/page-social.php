			...
			<!--Teeba Social -->
				<div class="row">
					...
					<h3 class="h3social">Teeba on Instagram</h3><i class="fa fa-instagram fasocialpos"></i>
						<iframe src="http://instaembedder.com/gallery-v2.php?width=430&cols=1&rows=5&margin=8&color=gray&likes=1&share_buttons=1&comments=1&date=1&link=1&frame=1&image_border=8&frame_color=white&cid=5677&" style="margin-top:34px;" scrolling='yes' frameborder="0" width="100%" height="365" ></iframe>
					</div>
				</div>
			<!-- /Teeba Social -->
			<!--Teeba Social -->
